...
<div class="card">
            ...
            <div class="card-body">
             ...
             <div class="col-md-6">
              ...
              <button type="button" class="btn btn-primary" onclick="clickSend()" style="display:flex;  justify-content: right; align-items:right; font-weight: bold; margin-left:5px; ">GENERATE</button>
                </div>
              </div>
                <br>
        ...
        <tbody>
            <tr>
                ...
                <td style=" text-align: center;" >BIPH2022-11614</td>
...
<br>
    <div class="row">
              ...
              <button type="button" class="btn btn-primary" onclick="clickSend()" style = "justify-content:left; color:black; font-weight: bold;justify-content:left;  margin-left: 20px; " id="edit">Save</button>
