...
<div class="pagetitle">
  ...
  <h1 class="custom-font" style="color:white; font-size: 48px;">Attendee Status</h1>
            ...
            <div class="card-body">
              ...
              $(document).ready(function(){
                  $('#selectedComboType').change(function(){
                      ...
                      $.ajax({
                          url: 'display_attendeestatus.php?fullname=<?php echo $fullname;?>&position=<?php echo $position;?>',
                          method: 'POST',
