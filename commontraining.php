...
<div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Common Training</h5>
   ...
   <form id="formid" class="row g-3" method="POST"  name="formid" action="forms/sqlupdates.php?action=commontraining&requestorname=<?php echo $fullname;?>">
    <?php
    
    $topic = 'commontraining';
    $monthtoday = date('F Y');
    ...
    ?>
          ...
          <div class="col-md-6">
                ...
                <select class="form-select"  id="topic" name="topic" aria-label="State" style="font-weight: bold; border-width:2px; border-style:solid;  padding: 10px; background-color: #FFF7DA; padding-top:25px;"required>
                <option value="" selected disabled>Select a topic</option>
                           
                           <?php
                              $commontrainingtopic = "SELECT available_topic FROM [dbo].[tbl_topicsetting] WHERE month ='$monthtoday' AND category = 'Common Training' ORDER BY available_topic ASC";
                ...
                <div class="col-md-6">
                  ...
                  <input type="date" class="form-control" id="start_enlist" name="start_enlist" placeholder="Start Enlist Date" require >
                ...
                <div class="col-md-6">
                  ...
                  <input type="date" class="form-control" id="end_enlist" name="end_enlist" placeholder="End Enlist Date"  require>
...
<form>
        ...
        <tbody>
        <?php
               $selectcommon = "SELECT * FROM [dbo].[tbl_topic_LIST_commontraining_MAINREQUEST] where Section = '$section'";
    ...
    if (count <= 0) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          window.location.href = 'forms/sqlupdates.php?action=commontrainingRemove&selectedItemId=' + vals.join(',') +
