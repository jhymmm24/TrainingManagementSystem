...
<body>
        ...
        <section>
            ...
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <h1 class="card-title" style="font-size: 36px;"><?php echo  "[$section Section] Skill Map - Mgt. Group Regulation";?></h1>
    ...
    <thead>
        <tr>
            ...
            $sql_getcolumn = "SELECT COLUMN_NAME
                              ...
                              WHERE TABLE_NAME = 'tbl_topic_LIST_mgtgroupregulation'";
    ...
    <tbody>
        ...
        // Query to fetch data
        $sql_getdata = "SELECT * FROM tbl_topic_LIST_mgtgroupregulation WHERE Section = '$section'";
...
<button class="button-cus1" id="saveButton" type="button" onclick="updateTableData('tbl_topic_LIST_mgtgroupregulation')">Save</button>
...
// Function to update table data
var tableName = "tbl_topic_LIST_mgtgroupregulation"; // Define table name
...
setTimeout(function(){ window.location='skillmap_mgtgroupregulation.php'; }, 2000);
