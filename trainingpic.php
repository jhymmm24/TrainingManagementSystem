...
<div class="card">
            ...
            <div class="card-body">
             ...
             <h5 class="card-title">Training PIC</h5>
          ...
          fetchEmployeeDetails(vals[0]).then(employeeDetails => {
            Swal.fire({
              ...
              html: `
                <div style="margin-bottom: 10px;">
                    <label for="fullname" class="form-label" style="color: white; display: block;">FULL NAME</label>
                    <input type="text" name="fullname" class="form-control" id="fullname" value="${employeeDetails.Full_Name}">
                </div>
                <div style="margin-bottom: 10px;">
                    <label for="adid" class="form-label" style="color: white; display: block;">ADID</label>
                    <input type="text" name="adid" class="form-control" id="adid" value="${employeeDetails.ADID}">
                </div>
                <div style="margin-bottom: 10px;">
                    <label for="email" class="form-label" style="color: white; display: block;">Email</label>
                    <input type="text" name="email" class="form-control" id="email" value="${employeeDetails.Email}">
                </div>
                ...
                <div style="margin-bottom: 10px;">
                   <select class="form-select" aria-label="Default select example" id="category" name ="category">
                    ...
                    <option value="Training PIC" ${employeeDetails.Category === 'Training PIC' ? 'selected' : ''}>Training PIC</option>
                    </select>
            ...
            `,
              ...
              preConfirm: () => {
                ...
                if (!Full_Name || !ADID || !Email || !Category) {
                  Swal.showValidationMessage(`Please enter all details`);
                }
                return { Full_Name: Full_Name, ADID: ADID, Email: Email, Category : Category };
              }
            }).then((result) => {
              if (result.isConfirmed) {
                const { Full_Name, ADID, Email, Category } = result.value;
                window.location.href = `forms/sqlupdates.php?action=EditTrainingPIC&selectedItemId=${vals[0]}&fullname=${encodeURIComponent(Full_Name)}&adid=${encodeURIComponent(ADID)}&email=${encodeURIComponent(Email)}&category=${encodeURIComponent(Category)}`;
              }
            });
          });
        }
