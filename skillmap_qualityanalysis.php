        ...
        <section>
            ...
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <h1 class="card-title" style="font-size: 36px;"><?php echo  "[$section Section] Skill Map - Quality Analysis";?></h1>
...
<table id="example23" class="display" style="width:100%; overflow-x: auto; white-space: nowrap; display: block;">
    <thead>
        <tr>
            ...
            $sql_getcolumn = "SELECT COLUMN_NAME
                              ...
                              WHERE TABLE_NAME = 'tbl_topic_LIST_qualityanalysis' ";
    ...
    <tbody>
        ...
        // Query to fetch data
        $sql_getdata = "SELECT * FROM tbl_topic_LIST_qualityanalysis WHERE Section = '$section'";
...
<button class="button-cus1" id="saveButton" type="button" onclick="updateTableData('tbl_topic_LIST_qualityanalysis')">Save</button>
</form>
...
// Function to update table data
var tableName = "tbl_topic_LIST_qualityanalysis"; // Define table name
...
setTimeout(function(){ window.location='skillmap_qualityanalysis.php'; }, 2000);
