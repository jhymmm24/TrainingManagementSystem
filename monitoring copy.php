...
<div class="card">
    ...
    <?php
        // Sanitize $section to prevent SQL injection
      
        
        // Prepare the SQL query
        $sql_fetch = "SELECT DISTINCT Title FROM [dbo].[tbl_elearningstatus] WHERE Section = ?";
        $stmt = sqlsrv_prepare($conn, $sql_fetch, array($section));
