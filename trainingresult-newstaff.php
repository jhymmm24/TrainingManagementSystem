...
<div class="pagetitle">
  ...
  <h1 class="custom-font" style="color:white; font-size: 48px;">New Staff - Development On-going...</h1>
   ...
   <div class="card">
        ...
        <thead>
            <tr>
                ...
                <th style=" text-align: center;">Target Employee</th>
    ...
    <?php
        ...
        //                 AND  Topic = 'New Staff Training'-- Adding filter for Status column
        //             )
        //             SELECT *
        //             FROM CTE
        //             WHERE RowNum = 1";
           ...
           $stmt_trainingrequest = sqlsrv_query($conn,$query_trainingrequest);
                          while($row = sqlsrv_fetch_array($stmt_trainingrequest, SQLSRV_FETCH_ASSOC)) {
                              ...
                              '<tr class="' . $rowClass . '">
                                  ...
                                  <td style=" text-align: center;">'  . $row['Employee Name'] .'</td>
                              ...
                              if ($category === "Admin" ) {
                                  if ($status !== 'DONE') {
                                      echo '<a href="newstaff_scoring.php?TrainingrequestID='.$requestnumber.'&TrainingTopic='.$topic.'&TargetEmployee='.$employeename.'"  class="btn btn-warning" style="background-color: transparent; border: none; text-align: center; align-items: center; display: flex; color: white;">
                          ...
                          <?php 
                                              ...
                                              if ($category === "Admin") {
                                                if ($status !== 'DONE') {
                                                    echo '<button onclick="alert(\'Training has not been finished scoring.\')" class="btn btn-warning" style="background-color: transparent; border: none; text-align: center; align-items: center; display: flex; color: white;">
                                                            <img src="assets/img/excel.png" style="width: 35px; height: 35px; border: none;" title="Download Excel">
                                                          </button>';
                                                } else {
                                                    echo '<a href="newstaff_scoring_view.php?TrainingrequestID=' . $requestnumber . '&TrainingTopic=' . $topic . '&TargetEmployee=' . $employeename . '" class="btn btn-info" style="background-color: transparent; border: none; text-align: center; align-items: center; display: flex; color: white;">
                                                            <img src="assets/img/excel.png" style="width: 35px; height: 35px; border: none;" title="Download Excel">
                                                          </a>';
                                                }
                                            } else {
                          ...
                          <!-- Additional button -->
                          <!-- <div style="display: inline-block;">
                          <a href="newstaff_scoring_view.php?TrainingrequestID=<?php echo $requestnumber?>&TrainingTopic=<?php echo $topic ?>&TargetEmployee=<?php echo $employeename?>" class="btn btn-info" style="background-color: transparent; border: none; text-align: center; align-items: center; display: flex; color: white;">
                                <img src="assets/img/excel.png" style="width: 35px; height: 35px; border: none;" title="View">
                            </a>
                          </div>
