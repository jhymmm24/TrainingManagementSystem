...
<div class="card">
            ...
            <?php 
             ...
             $get_data = "SELECT  * FROM [dbo].[tbl_topic_LIST_qualityanalysis_MAINREQUEST] WHERE  [RequestNumber] = '$trainingrequestid'";
     ...
     <form id="form" class="row g-3" method="POST"  name="form" action="forms/sqlupdates.php?action=scoring_qualityanalysis" onsubmit="return validateCheckboxes()" autocomplete="off">

    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Quality Analysis - <?php echo $trainingtopic; ?></h5>
...
<input type="hidden" name="trainingrequestid" value="<?php echo $trainingrequestid; ?>">
            ...
            $sql_fetchemployee = "SELECT * FROM [dbo].[tbl_topic_LIST_qualityanalysis_MAINREQUEST] WHERE [RequestNumber] = '$trainingrequestid'";
            ...
            $sql_getdata = "SELECT " . implode(', ', $columnsToDisplay) . " FROM [dbo].[tbl_topic_LIST_qualityanalysis_MAINREQUEST] WHERE [RequestNumber] = '$trainingrequestid'";
