...
<div class="card">
    <div class="card-body">
        <h5 class="card-title">Technical Standard</h5>
        ...
        <form id="formid" class="row g-3" method="POST" name="formid" action="forms/sqlupdates.php?action=techstandard&requestorname=<?php echo $fullname;?>">
            ...
            <div class="col-md-6">
                <div class="form-floating">
                    ...
                    <option value="" selected disabled>Select a topic</option>
                        <?php
                            $commontrainingtopic = "SELECT available_topic FROM [dbo].[tbl_topicsetting] WHERE month ='$monthtoday' AND category = 'Technical Standard' ORDER BY available_topic ASC";
...
<form>
        ...
        <tbody>
        <?php
               $selectcommon = "SELECT * FROM [dbo].[tbl_topic_LIST_technicalstandard_MAINREQUEST] where Section = '$section'";
...
<!-- Hidden input for training type -->
<input type="hidden" id="trainingTypeInput" name="trainingType">
    ...
    if (count <= 0) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          window.location.href = 'forms/sqlupdates.php?action=technicalstandardRemove&selectedItemId=' + vals.join(',') +
