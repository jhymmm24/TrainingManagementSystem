...
<div class="pagetitle">
  ...
  <h1 class="custom-font" style="color:white; font-size: 48px;">Training Scoreboard</h1>
            ...
            <div class="card-body">
              ...
              $(document).ready(function(){
                  $('#selectedComboType').change(function(){
                      ...
                      $.ajax({
                          url: 'display_table_scores.php?fullname=<?php echo $fullname;?>&position=<?php echo $position;?>',
                          method: 'POST',
