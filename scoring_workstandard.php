...
<div class="card">
            ...
            <?php 
             ...
             $get_data = "SELECT  * FROM [dbo].[tbl_topic_LIST_workstandard_MAINREQUEST] WHERE  [RequestNumber] = '$trainingrequestid'";
     ...
     <form id="form" class="row g-3" method="POST"  name="form" action="forms/sqlupdates.php?action=scoring_workstandard" onsubmit="return validateCheckboxes()" autocomplete="off">

     <div class="card">
            <div class="card-body">
              <h5 class="card-title">Work Standard  - <?php echo $trainingtopic; ?></h5>
...
<input type="hidden" name="trainingrequestid" value="<?php echo $trainingrequestid; ?>">
              ...
              <?php
                ...
                $sql_fetchemployee = "SELECT  * FROM [dbo].[tbl_topic_LIST_workstandard_MAINREQUEST] WHERE  [RequestNumber] = '$trainingrequestid'";
...
elseif ($trainingtopic == 'Work Standard for Handling Belt Conveyors') {
  ...
  echo "Cant find Column";
            ...
            $sql_getdata = "SELECT " . implode(', ', $columnsToDisplay) . " FROM [dbo].[tbl_topic_LIST_workstandard_MAINREQUEST] WHERE [RequestNumber] = '$trainingrequestid'";
