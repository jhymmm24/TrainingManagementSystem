...
// Check if the user is logged in and has the correct category (SUPERADMIN)
// if (!isset($_SESSION['TMSuser_id']) || $_SESSION['category'] != 'SUPERADMIN') {
//   Redirect to login page or a restricted access page
//   header('Location: ../restricted.php'); // Or redirect to login page
//   exit();
// }

// If the user is logged in and is a SUPERADMIN, allow access to the page
// echo "Welcome to the SUPERADMIN page!";
...
<!-- 
          <div class="col-md-6">
                  ...
                  <label for="floatingSelect" style="background-color:F3EA9C; margin-top:-10px">Request Date :</label>

                <select class="form-select"  onchange="selectComboBox()" id="selectedCombo" aria-label="State" style="font-weight: bold; border-width:2px; border-style:solid; border-color:#B45309; padding: 10px; background-color: #FEF3C7; padding-top:25px;">
                ...
                <select class="form-select"   id="selectedComboType" aria-label="State" style="font-weight: bold; border-width:2px; border-style:solid; border-color:#B45309; padding: 10px; background-color: #FEF3C7; padding-top:25px;">
                       <option selected>-</option>
                        ...
                        <option value="Work Standard">Work Standard</option>
                        <option value="Mgt Group Regulation">Mgt Group Regulation</option>
                        <option value="Common Training">Common Training</option>
                        <option value="Prod. HASHIRA">Prod. HASHIRA</option>
