...
<div class="card">
            ...
            <div class="card-body">
             ...
             <h5 class="card-title">Upload Skill Map</h5>
...
<div class="row">
    ...
    <form action="upload_skillmap.php" id="form1" method="post" enctype="multipart/form-data">
        <div class="row">
        ...
        <div class="col-md-3">
                ...
                <div class="col-md-3">
                        <select class="form-select" name="trainingtype" id="trainingtype" required>
                            ...
                            <option value="WorkStandard">Work Standard</option>
                            <option value="MgtGroupRegulation">Mgt Group Regulation</option>
                            <option value="CommonTraining">Common Training</option>
                            <option value="ProdHashira">Prod.Hashira</option>
                            <option value="TechnicalStandard">Technical Standard</option>
                            <option value="CommonBusinessSkills">Common Business Skills</option>
                            <option value="CompanyFundamentals">Company Fundamentals</option>
