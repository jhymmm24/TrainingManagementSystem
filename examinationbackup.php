    ...
    if (isset($_POST['submit_answers'])) {
        ...
        if ($score == $total_questions) {
            ...
            if ($attempts > 0) {
                ...
                // Set cooldown period
                $_SESSION['cooldown_end_time'] = time() + 300; // 300 seconds cooldown
                $attempts = 3; // Reset attempts to 3
                echo "You've exhausted all attempts. Please wait <span id='cooldown_timer'>300</span> seconds before trying again.";
                // JavaScript for updating cooldown timer dynamically
                echo "<script>
                        setInterval(function() {
                            var timerElement = document.getElementById('cooldown_timer');
