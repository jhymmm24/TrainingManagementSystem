...
<div class="card">
            ...
            <div class="card-body">
             ...
             <h5 class="card-title">Training Topic  Uploading</h5>
...
<div class="row">
    ...
    <form action="upload_topic.php" id="form1" method="post" enctype="multipart/form-data">
        <div class="row">

         
        <div class="col-md-3">
                  <div class="form-floating">
                  <label for="floatingSelect" style="background-color:F3EA9C; margin-top:-10px">Training Name :</label>

                <select class="form-select"   name="selectedComboType" id="selectedComboType" aria-label="State" style="font-weight: bold; border-width:2px; border-style:solid; border-color:#B45309; padding: 10px; background-color: #FEF3C7; padding-top:25px;">
