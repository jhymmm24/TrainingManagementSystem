...
<div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Management Group Regulation</h5>
   ...
   <form id="formid" class="row g-3" method="POST"  name="formid" action="forms/sqlupdates.php?action=mgtgroupregulation&requestorname=<?php echo $fullname;?>">

   <?php
   
   $topic = "mgtgroupregulation";
   $monthtoday = date('F Y');
   ?>
          ...
          <div class="col-md-6">
                ...
                <option value="" selected disabled>Select a topic</option>
                           ...
                           <?php
                              $commontrainingtopic = "SELECT available_topic FROM [dbo].[tbl_topicsetting] WHERE month ='$monthtoday' AND category = 'Mgt Group Regulation' ORDER BY available_topic ASC";
...
<form>
        ...
        <tbody>
        <?php
               $selectcommon = "SELECT * FROM [dbo].[tbl_topic_LIST_mgtgroupregulation_MAINREQUEST] where Section = '$section'";
    ...
    if (count <= 0) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          window.location.href = 'forms/sqlupdates.php?action=mgtgroupregulationRemove&selectedItemId=' + vals.join(',') +
