...
foreach ($_POST['selected'] as $selectedValues) {
    ...
    if (!empty($target_empnames)) {
		...
		$body = '<p style="font-family:arial, sans-serif; font-size:16px;">Dear PE Training PIC,</p>';
        ...
        // Add main recipients
        $sql2 = "SELECT * FROM [dbo].[tbl_ems] WHERE Full_Name = '$petrainingpic'";
        ...
        // Add CC recipients
        $sql_CC = "SELECT * FROM [dbo].[tbl_ems] WHERE Full_Name = '$sectionspv'";
        ...
        while ($row = sqlsrv_fetch_array($results_CC, SQLSRV_FETCH_ASSOC)) {
            try {
		      ...
		      // Add CC recipients
			  $sql_CC2 = "SELECT * FROM [dbo].[tbl_ems] WHERE Full_Name = '$requestorname'";
