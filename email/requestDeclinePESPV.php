...
$mail = new \PHPMailer\PHPMailer\PHPMailer();
				...
				$body = '<p style="font-family:arial, sans-serif; font-size:16px;">Good day, this is to inform that '.$topic.'Training Request has been declined by PE Supervisor.</p>
				<p style="font-family:arial, sans-serif; font-size:16px;">Declined Reason: '.$declined_reason_pespv.'</p>
				...
				<td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$declined_pe_spv</td>
