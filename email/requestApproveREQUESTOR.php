...
foreach ($_POST['selected'] as $selectedValues) {
    ...
    if (!empty($target_empnames)) {
        ...
        $body = '<p style="font-family:arial, sans-serif; font-size:16px;">Dear All,</p>';
        $body .= '<p style="font-family:arial, sans-serif; font-size:16px;">Good day, this is to inform that ' . $topic . ' Training Request has been approved by PE Manager.</p>';
