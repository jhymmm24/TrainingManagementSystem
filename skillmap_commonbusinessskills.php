        ...
        <section>
            ...
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <h1 class="card-title" style="font-size: 36px;"><?php echo  "[$section Section] Skill Map - Common Business Skills ";?></h1>
...
<form id="skillmapform" method="post" action="forms/sqlupdates.php?action=update">
    ...
    <thead>
        ...
        <?php
            ...
            $sql_getcolumn = "SELECT COLUMN_NAME
                              ...
                              WHERE TABLE_NAME = 'tbl_topic_LIST_commonbusinesskill' ";
    ...
    <tbody>
        ...
        <?php
         ...
         // Query to fetch data
         $sql_getdata = "SELECT * FROM tbl_topic_LIST_commonbusinesskill WHERE Section = '$section'";
...
<button class="button-cus1" id="saveButton" type="button" onclick="updateTableData('tbl_topic_LIST_commonbusinesskill')">Save</button>
...
// Function to update table data
var tableName = "tbl_topic_LIST_commonbusinesskill"; // Define table name
...
setTimeout(function(){ window.location='skillmap_commonbusinessskills.php'; }, 2000);
