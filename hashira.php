...
<div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Production Hashira</h5>
   ...
   <form id="formid" class="row g-3" method="POST"  name="formid" action="forms/sqlupdates.php?action=prodhashira&requestorname=<?php echo $fullname;?>">
...
<form>
        ...
        <tbody>
        <?php
               $selectcommon = "SELECT * FROM [dbo].[tbl_topic_LIST_hashira_MAINREQUEST] where Section = '$section'";
  ...
  if (count <= 0) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = 'forms/sqlupdates.php?action=prodhashiraRemove&selectedItemId=' + vals.join(',');
      }
    });
  }
}
