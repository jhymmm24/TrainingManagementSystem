...
<body>
        ...
        <section>
            ...
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <h1 class="card-title" style="font-size: 36px;"><?php echo  "[$section Section] Skill Map - Common Training";?></h1>
    ...
    <thead>
        ...
        <?php
            ...
            $sql_getcolumn = "SELECT COLUMN_NAME
                              ...
                              WHERE TABLE_NAME = 'tbl_topic_LIST_commontraining' ";
    ...
    <tbody>
        ...
        // Query to fetch data
        $sql_getdata = "SELECT * FROM tbl_topic_LIST_commontraining WHERE Section = '$section'";
...
<button class="button-cus1" id="saveButton" type="button" onclick="updateTableData('tbl_topic_LIST_commontraining')">Save</button>
...
// Function to update table data
var tableName = "tbl_topic_LIST_commontraining"; // Define table name
...
setTimeout(function(){ window.location='skillmap_cmntraining.php'; }, 2000);
